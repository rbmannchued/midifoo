...
The goal is to get an inexpensive stompbox that meets all the needs of a musician in a live perfomance. All the parts of this projects are found in the open-source GPL license which means free to use and modify, you can build your own midifoo with the instructions below.
<p>
